...
import me.ht9.rose.util.render.shader.TesselatorVertexState;
import org.lwjgl.opengl.GL11;

import java.nio.*;
import java.util.PriorityQueue;

public class FrameTessellator
{
    ...
    public static final FrameTessellator instance = new FrameTessellator(2097152);
    ...
    private FrameTessellator(int par1)
    {
